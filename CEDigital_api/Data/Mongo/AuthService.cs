...
namespace CEDigital_api.Data.Mongo
{
    public class AuthService
    {
        ...
        public async Task<(bool success, string role, string message, string id, string carnet)> LoginAsync(string correo, string password)
        {
            ...
            {
                return (true, profesor.IsAdmin ? "admin" : "profesor", "Inicio de sesión exitoso", profesor.Id, profesor.cedula);
            }
            ...
            {
                return (true, "estudiante", "Inicio de sesión exitoso", estudiante.Id, estudiante.carnet);
            }
