...
namespace CEDigital_api.Data.Mongo
{
    public class AuthService
    {
        ...
        public async Task<(bool success, string role, string message, string id, string carnet, bool isAdmin)> LoginAsync(string correo, string password)
        {
            ...
            {
                return (true, "professor", "Inicio de sesión exitoso", profesor.Id, profesor.cedula, profesor.IsAdmin);
            }
            ...
            {
                return (true, "estudiante", "Inicio de sesión exitoso", estudiante.Id, estudiante.carnet, false);
            }

            return (false, "", "Credenciales inválidas", "", "", false);
        }
    }
}
